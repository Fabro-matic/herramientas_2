...
class Herramientas:
    ...
    def __init__(self, window):
        ...
        tabla_frame.grid(row = 9, column = 0, columnspan = 2, sticky = W + E)
...
#PARA OPERAR CON LA DB
    ...
    def mostrar_por_ubicación(self, ubicación):
        ...
        self.total_label = Label(self.ubic_win, text = 'TOTAL HERRAMIENTAS ELÉCTRICAS: 0', font = self.bold_font, fg = "blue")
        self.total_label.grid(row = 1, column = 0, columnspan = 2, pady = 10, sticky = W+E)
